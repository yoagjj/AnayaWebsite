  ...
  if (!isLoggedIn) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-brand-cream">
        <div className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-sm border border-brand-brown/10">
          {/* Header */}
          <div className="text-center mb-8">
            <h2 className="text-4xl font-serif text-brand-brown mb-2">Anaya</h2>
            <p className="text-xs uppercase tracking-[0.3em] text-brand-brown/40">
              Admin Panel
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-brand-brown/70 mb-2">
                Password
              </label>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-brand-brown/20 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-brand-brown/30 bg-brand-cream text-brand-brown placeholder:text-brand-brown/30"
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-brand-brown/40 hover:text-brand-brown transition"
                >
                  {showPassword ? (
            ...
            <button
              ...
              className="w-full bg-brand-brown hover:bg-brand-sage text-white font-medium py-3 rounded-xl transition-all duration-500 text-sm uppercase tracking-widest disabled:opacity-50"
            >
    ...
    <div className="pt-32 pb-24 px-6 min-h-screen bg-neutral-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <div>
            <h1 className="text-4xl font-serif text-brand-brown">
              Admin Dashboard
            </h1>
            <p className="text-brand-brown/40 font-light mt-1 uppercase tracking-widest text-xs">
              Manage Anaya Collection
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white p-8 rounded-3xl shadow-sm flex items-center space-x-6 border border-brand-brown/5">
            ...
            <div>
              <p className="text-xs uppercase tracking-widest text-brand-brown/40 font-medium">
                Total Items
              </p>
                ...
                <tbody className="divide-y divide-brand-brown/5">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-brand-brown/40 font-light truncate max-w-[200px]">
                              {product.size}
                            </p>
                          </div>
                        </div>
                      ...
                      <td className="px-8 py-6 text-right">
                        <div className="flex items-center justify-end space-x-2">
                          <button
                            ...
                            className="p-2 text-brand-brown/40 hover:text-brand-sage hover:bg-brand-sage/10 rounded-lg transition-all"
                          >
                            <Edit2 className="w-4 h-4" />
                          </button>
                          <button
                            onClick={() => handleDelete(product.id)}
                            className="p-2 text-brand-brown/40 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all"
                          >
                  ...
                  {filteredProducts.length === 0 && (
                    <tr>
                      <td
                        colSpan={5}
                        className="p-16 text-center text-brand-brown/20 italic font-serif"
                      >
                        No products found.
                      </td>
                    </tr>
          ...
          <>
            ...
            >
              ...
              <div className="px-10 py-8 border-t border-brand-brown/5 flex justify-end space-x-4">
                <button
                  onClick={closeModal}
                  className="px-8 py-4 rounded-full text-xs uppercase tracking-widest font-bold text-brand-brown/40 hover:text-brand-brown transition-colors"
                >
                  Cancel
                </button>
                <button
